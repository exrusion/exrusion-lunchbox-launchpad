...
function App(){
 ...
 <section className="hero"><div className="eyebrow"><Sparkles size={15}/> PONS V2 · FRESHLY PACKED ON ROBINHOOD CHAIN</div><h1>Pack your own<br/><em>launchpad.</em></h1><p>Create a branded token launchpad with isolated ownership and automatic fee routing. You bring the big idea. We pack the rails.</p><div className="actions"><button className="primary" onClick={()=>openBuilder()}>Pack my launchpad <ChevronRight/></button><a className="ghost" href="#directory">See what’s on the menu</a></div><div className="fee"><span><b>70%</b> creator</span><span><b>20%</b> lunchpad owner</span><span><b>10%</b> protocol</span></div><LunchArt/></section>
